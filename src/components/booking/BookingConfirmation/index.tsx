 ...
 *
 * Displays booking confirmation page with reservation details retrieved from localStorage.
 * Shows a thank you message and booking details (date, time, guests, occasion).
