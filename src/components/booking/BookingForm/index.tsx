...
interface BookingFormProps {
  ...
  /** Object containing available time slots for the selected date */
  availableTimes: {
    times: string[];
  };
}
 ...
 *
 * A form component for making restaurant reservations. Includes validation
 * for date, time, number of guests, and occasion. Automatically updates
 * available times when the date changes.
 *
 * @param {BookingFormProps} props - Component props
 * @param {Dispatch<{type: string; date: Date}>} props.dispatch - Function to dispatch time updates
 * @param {{times: string[]}} props.availableTimes - Available time slots for selected date
 * @returns {ReactElement} The booking form component
 */
