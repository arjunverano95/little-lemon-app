 ...
 * Contact Component
 *
 * Displays contact information section with phone, email, address, and hours.
 * Includes clickable links for phone and email. Has id="contact" for anchor navigation.
 *
 * @returns {ReactElement} The contact information section component
 */
