 ...
 *
 * Displays a section with customer testimonials. Shows multiple
 * TestimonialCard components in a responsive grid layout.
 *
 * @returns {ReactElement} The customer testimonials section component
 */
const Testimonials: FC = (): ReactElement => {
  return (
    <Box as="section" py={20} px={4} bg="gray.50">
