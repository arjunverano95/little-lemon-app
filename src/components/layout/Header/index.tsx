 ...
 * Header Component
 *
 * Fixed header that contains navigation. Automatically hides when scrolling down
 * and shows when scrolling up for better user experience.
 *
 * @returns {ReactElement} The header component with navigation
 */
const Header: FC = (): ReactElement => {
  ...
  /**
   * Handles scroll events to show/hide the header.
